...
$withdrawals = [
    ['id' => 1, 'user' => 'Ram Shrestha', 'phone' => '9841000001', 'amount' => 5000, 'method' => 'Bank Transfer', 'bank' => 'NMB Bank', 'account' => '1234567890', 'status' => 'pending', 'date' => date('Y-m-d H:i:s', strtotime('-30 min'))],
    ['id' => 2, 'user' => 'Sita Pandey', 'phone' => '9841000002', 'amount' => 3000, 'method' => 'eSewa', 'bank' => 'eSewa', 'account' => '9841******', 'status' => 'pending', 'date' => date('Y-m-d H:i:s', strtotime('-1 hour'))],
    ['id' => 3, 'user' => 'Hari Kumar', 'phone' => '9841000003', 'amount' => 8000, 'method' => 'Bank Transfer', 'bank' => 'NIC Asia', 'account' => '9876543210', 'status' => 'completed', 'date' => date('Y-m-d H:i:s', strtotime('-1 day'))],
    ['id' => 4, 'user' => 'Gita Devi', 'phone' => '9841000004', 'amount' => 2000, 'method' => 'Khalti', 'bank' => 'Khalti', 'account' => '9842******', 'status' => 'completed', 'date' => date('Y-m-d H:i:s', strtotime('-2 days'))],
    ['id' => 5, 'user' => 'Mohan Rai', 'phone' => '9841000005', 'amount' => 10000, 'method' => 'Bank Transfer', 'bank' => 'Standard Chartered', 'account' => '4567891230', 'status' => 'failed', 'date' => date('Y-m-d H:i:s', strtotime('-3 days'))],
];
...
<head>
    ...
    <title>Nepal Pay Admin - Withdrawals</title>
...
<body class="bg-gray-50">
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="withdrawals.php" class="active"><i class="fas fa-arrow-up icon"></i> Withdrawals</a>
    ...
    <header class="admin-topbar">
        <div class="admin-topbar-left"><h2 class="admin-topbar-title">Withdrawals</h2></div>
        <div class="admin-topbar-right">
            <div class="navbar-search"><input type="text" placeholder="Search..." class="bg-gray-100"></div>
            <button class="navbar-notification"><i class="fas fa-bell text-gray-600"></i><span class="badge">2</span></button>
        ...
        <div class="max-w-7xl mx-auto">
            <div class="page-header">
                <div>
                    ...
                    <p class="page-subtitle">Manage withdrawal requests</p>
                </div>
            </div>
            ...
            <div class="grid-4 mb-6">
                <div class="stats-card">
                    ...
                    <div class="stats-card-content">
                        ...
                        <div class="stats-card-value"><?php echo count(array_filter($withdrawals, fn($w) => $w['status'] === 'pending')); ?></div>
                    </div>
                </div>
                <div class="stats-card">
                    ...
                    <div class="stats-card-content">
                        ...
                        <div class="stats-card-value"><?php echo count(array_filter($withdrawals, fn($w) => $w['status'] === 'completed')); ?></div>
                    </div>
                </div>
                <div class="stats-card">
                    ...
                    <div class="stats-card-content">
                        ...
                        <div class="stats-card-value"><?php echo count(array_filter($withdrawals, fn($w) => $w['status'] === 'failed')); ?></div>
                    </div>
                </div>
                <div class="stats-card">
                    <div class="stats-card-icon primary"><i class="fas fa-dollar-sign"></i></div>
                    <div class="stats-card-content">
                        <div class="stats-card-label">Total Withdrawn</div>
                        <div class="stats-card-value">Rs <?php echo number_format(array_sum(array_column($withdrawals, 'amount'))); ?></div>
                    </div>
                </div>
            </div>
            ...
            <!-- Withdrawals Table -->
            <div class="card">
                <h3 class="card-title mb-4">Withdrawal Requests</h3>
                            ...
                            <tr>
                                <td>
                                    <div class="table-user">
                                        <div class="avatar"><?php echo strtoupper(substr($withdrawal['user'], 0, 1)); ?></div>
                                        <div>
                                            <div class="table-user-name"><?php echo htmlspecialchars($withdrawal['user']); ?></div>
                                            <div class="table-user-phone"><?php echo htmlspecialchars($withdrawal['phone']); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="font-semibold text-lg text-red-600">Rs <?php echo number_format($withdrawal['amount']); ?></td>
                                <td><?php echo htmlspecialchars($withdrawal['method']); ?></td>
                                <td><?php echo htmlspecialchars($withdrawal['bank']); ?></td>
                                <td class="font-mono"><?php echo htmlspecialchars($withdrawal['account']); ?></td>
                                <td>
                                ...
                                <td><?php echo date('M d, h:i A', strtotime($withdrawal['date'])); ?></td>
                                <td>
                                    ...
                                    <form method="POST" class="inline">
                                        ...
                                        <button type="submit" class="btn btn-sm btn-danger" onclick="return confirm('Reject this withdrawal?')">Reject</button>
                                    </form>
                                    <?php else: ?>
