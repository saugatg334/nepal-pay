...
$balance = 12500.75;
$transactions = [
    [ 'id' => 1, 'type' => 'Received', 'name' => 'Ram Shrestha', 'amount' => 2500, 'date' => 'Nov 20, 2025' ],
    [ 'id' => 2, 'type' => 'Sent', 'name' => 'Asha Store', 'amount' => -950.5, 'date' => 'Nov 18, 2025' ],
    [ 'id' => 3, 'type' => 'Top-up', 'name' => 'Bank Transfer', 'amount' => 5000, 'date' => 'Nov 12, 2025' ],
    [ 'id' => 4, 'type' => 'Paid', 'name' => 'Electricity', 'amount' => -1200, 'date' => 'Nov 10, 2025' ],
];
?>
...
<head>
  ...
  <title>Esewa Clone Wallet</title>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', () => {
      ...
      sendForm.addEventListener('submit', function(e) {
        ...
        balanceElem.textContent = formatRs(currentBalance);
...
<body class="min-h-screen bg-gradient-to-tr from-gray-50 to-gray-100 p-6 font-sans text-gray-800">
  <div class="max-w-[1200px] mx-auto bg-white rounded-2xl shadow-lg overflow-hidden grid grid-cols-12">
    <!-- Sidebar -->
    <aside class="col-span-3 bg-gradient-to-b from-indigo-600 to-indigo-700 text-white p-6">
      <div class="flex items-center gap-3 mb-8">
        <div class="w-12 h-12 rounded-full bg-white/20 flex items-center justify-center text-xl font-bold">S</div>
        <div>
          <div class="text-sm opacity-90">Welcome,</div>
          <div class="font-semibold">Saugat Gautam</div>
        </div>
      </div>
    ...
    <main class="col-span-9 p-6">
      <header class="flex items-center justify-between">
        <div class="flex items-center gap-4">
          <h1 class="text-xl font-semibold">Esewa — Desktop Clone</h1>
      ...
      <section class="mt-6 grid grid-cols-3 gap-6">
        ...
        <div class="col-span-2 grid grid-cols-3 gap-4">
          <div class="p-5 bg-white rounded-2xl shadow-sm">
            ...
            <div class="mt-4 text-sm text-gray-500">Send money to bank or eSewa ID instantly.</div>
            <div class="mt-4">
          ...
          <div class="p-5 bg-white rounded-2xl shadow-sm">
            ...
            <div class="mt-4">
              <button class="px-4 py-2 rounded-lg border">Top-Up</button>
            </div>
          </div>
          ...
          <div class="p-5 bg-white rounded-2xl shadow-sm">
            ...
            <div class="mt-4">
              <button class="px-4 py-2 rounded-lg border">Pay Bill</button>
            </div>
          </div>
        </div>
        ...
        <div class="p-5 bg-gradient-to-b from-yellow-50 to-white rounded-2xl shadow-sm">
          ...
          <div class="mt-4 flex gap-2">
            ...
            <button id="sendMoneyBtn2" class="px-3 py-2 rounded-lg bg-indigo-600 text-white">Send</button>
          </div>
        </div>
      </section>
          ...
          <ul class="mt-4 divide-y">
            <?php foreach ($transactions as $tx): ?>
              <li class="py-3 flex items-center justify-between">
                <div>
                  <div class="font-medium"><?php echo htmlspecialchars($tx['name']); ?></div>
                  <div class="text-xs text-gray-400"><?php echo htmlspecialchars($tx['date']) . ' • ' . htmlspecialchars($tx['type']); ?></div>
                </div>
      ...
      <footer class="mt-6 text-center text-xs text-gray-400">Esewa clone UI — demo • Not affiliated with eSewa</footer>
    </main>
  </div>
  ...
  <div id="transferModal" class="hidden fixed inset-0 bg-black/40 flex items-center justify-center p-6">
    <div class="bg-white rounded-2xl p-6 w-full max-w-md">
      ...
      <form id="sendForm" class="mt-4 space-y-3">
        <div>
          <label class="text-xs text-gray-500" for="to">To (eSewa ID / Bank)</label>
